...
import { macarons ,blue,macarons2} from './theme';

echarts.registerTheme('macarons', macarons);
echarts.registerTheme('blue', blue);
echarts.registerTheme('macarons2', macarons2);
    ...
    render(){
        const menu = (
            <Menu onClick={this.handleMenuClick}>
                <Menu.Item key="macarons">macarons</Menu.Item>
                <Menu.Item key="blue">blue</Menu.Item>
                <Menu.Item key="macarons2">macarons2</Menu.Item>
            </Menu>
        );
        return (
